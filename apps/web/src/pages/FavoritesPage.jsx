...
const FavoritesPage = () => {
  ...
  // Features flags
  const foldersEnabled = getConfigValue('features.favorites.folders.enabled') !== false;
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="py-6 bg-white shadow-sm border-b">
        <div className="container-responsive">
          <div className={`grid grid-cols-2 ${foldersEnabled ? 'md:grid-cols-4' : 'md:grid-cols-3'} gap-4`}>
            <div className="text-center">
          ...
          <div className="flex gap-6">
            ...
            <div className="flex-1">
              <FavoritesList
                ...
                selectedFolder={foldersEnabled ? selectedFolder : null}
              />
            </div>
          </div>
        </div>
      ...
      {/* Modal crear carpeta */}
      <AnimatePresence>
        {foldersEnabled && showCreateFolder && (
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
